const openapi = {
  ...
  paths: {
    ...
    '/clients': {
      get: operation('Clientes', 'Listar clientes'),
      post: operation('Clientes', 'Crear cliente'),
    },
    ...
    '/products': {
      get: operation('Productos', 'Listar productos'),
      post: operation('Productos', 'Crear producto'),
    },
    ...
    '/employees': {
      get: operation('Colaboradores', 'Listar colaboradores'),
      post: operation('Colaboradores', 'Crear colaborador'),
    },
    '/employees/{id}/status': {
      patch: operation('Colaboradores', 'Activar o desactivar colaborador'),
    },
...
function item(tag, summary) {
  return {
    get: operation(tag, summary),
    put: operation(tag, `Actualizar ${summary.toLowerCase()}`),
  };
}
